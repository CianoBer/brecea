if exists (select * from dbo.sysobjects where id = object_id(N'TP_VISTADOCUMENTIMISS') and OBJECTPROPERTY(id, N'IsView') = 1)
    drop view TP_VISTADOCUMENTIMISS
GO
...
FROM
    ...
    LEFT OUTER JOIN
    VISTAARTICOLIUMBASE
    ON  VISTAARTICOLIUMBASE.codice = RD.CODART,TABCAMBI TCAM, TABUTENTI
...
GO
GRANT SELECT ON TP_VISTADOCUMENTIMISS TO METODO98
GO
